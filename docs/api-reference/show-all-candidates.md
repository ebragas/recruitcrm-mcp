<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/17a84fcafff6e-show-all-candidates -->
<!-- title: Show all candidates | API Endpoints -->
...
- `contractor_status` (string, optional) — `available`, `assigned` Not Setcreatedonupdatedon select an option (defaults to: updatedon) sort\_order: Not Setascdesc select an option (defaults to: desc) (example: `available`)
