<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/e46f61091108f-unenroll-candidate -->
<!-- title: Unenroll Candidate | API Endpoints -->

# Unenroll Candidate

**POST** `/v1/candidates/{candidate}/un-enroll`
...
```
curl --request POST \
  --url https://api.recruitcrm.io/v1/candidates/{candidate}/un-enroll \
