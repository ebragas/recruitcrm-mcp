<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/w8tya714zxub3-create-email-draft -->
<!-- title: Create Email Draft | API Endpoints -->
...
- `draft_status_id` (integer, optional) — Id to check Status Of Draft Created (example: `1`)
...
```
curl --request POST \
  --url https://api.recruitcrm.io/v1/drafts \
