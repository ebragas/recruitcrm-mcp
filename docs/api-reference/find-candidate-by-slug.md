<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/6de2e46e80e6a-find-candidate-by-slug -->
<!-- title: Find candidate by slug | API Endpoints -->

# Find candidate by slug

**GET** `/v1/candidates/{candidate}`
