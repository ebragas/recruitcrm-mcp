<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/bbe24a05e8869-candidate-work-experience -->
<!-- title: Candidate Work Experience | API Endpoints -->

# Candidate Work Experience

**GET** `/v1/candidates/{candidate}/work-history`

Get a list of Candidate Work Experience.
...
Array of objects for Candidate work history
...
```
curl --request GET \
  --url https://api.recruitcrm.io/v1/candidates/{candidate}/work-history \
