<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/7a7c3444d4b7a-get-list-of-companies-which-are-marked-as-off-limit -->
<!-- title: Get List of Companies which are marked as off limit | API Endpoints -->

# Get List of Companies which are marked as off limit

**GET** `/v1/companies/off-limit`
...
```
curl --request GET \
  --url https://api.recruitcrm.io/v1/companies/off-limit \
