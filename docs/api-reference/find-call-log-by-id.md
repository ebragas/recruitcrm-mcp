<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/7a35917e064f0-find-call-log-by-id -->
<!-- title: Find call log by ID | API Endpoints -->

# Find call log by ID

**GET** `/v1/call-logs/{call\_log}`
...
- `recording_required` (string, optional) — Indicates if the recording link should be included (allowed: `truefalse10`)
...
- `recording` (string, optional) — Recording URL (it will only shown if recording\_required param is true and there is recording available else null) and this recording will expire one hour after it is generated. Not Settruefalse10 select an option
