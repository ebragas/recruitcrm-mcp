<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/c44e8779214d0-edit-a-note -->
<!-- title: Edit a note | API Endpoints -->
...
- `note` (integer, **required**) — ID of the note to edit
