<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/a80c7563da47e-find-company-by-slug -->
<!-- title: Find company by slug | API Endpoints -->
...
- `company` (string, **required**) — slug of the company to return
