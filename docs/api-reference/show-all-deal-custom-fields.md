<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/75a40cd4459b2-show-all-deal-custom-fields -->
<!-- title: Show all Deal Custom Fields | API Endpoints -->

# Show all Deal Custom Fields
...
```
curl --request GET \
  --url https://api.recruitcrm.io/v1/custom-fields/deals \
