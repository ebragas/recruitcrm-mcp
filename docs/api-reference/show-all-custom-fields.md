<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/ea2ba4ccab5ce-show-all-custom-fields -->
<!-- title: Show all Custom Fields | API Endpoints -->
...
```
curl --request GET \
  --url https://api.recruitcrm.io/v1/custom-fields \
