<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/0bd81429644bf-edit-meeting -->
<!-- title: Edit meeting | API Endpoints -->

# Edit meeting

**POST** `/v1/meetings/{meeting}`
...
- `meeting` (integer, **required**) — ID of the meeting to edit
