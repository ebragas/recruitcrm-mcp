<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/8127b6a955337-show-all-candidate-custom-fields -->
<!-- title: Show all Candidate Custom Fields | API Endpoints -->

# Show all Candidate Custom Fields

**GET** `/v1/custom-fields/candidates`
...
```
curl --request GET \
  --url https://api.recruitcrm.io/v1/custom-fields/candidates \
