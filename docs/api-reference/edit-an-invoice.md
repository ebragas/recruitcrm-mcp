<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/6d3f70390a412-edit-an-invoice -->
<!-- title: Edit an invoice | API Endpoints -->
...
- `id` (integer, **required**) — ID of the invoice to edit
...
- `message` (string, optional) (example: `Invoice updated successfully`)
