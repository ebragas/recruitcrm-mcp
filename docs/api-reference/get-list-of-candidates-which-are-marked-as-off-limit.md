<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/0d36859314869-get-list-of-candidates-which-are-marked-as-off-limit -->
<!-- title: Get List of candidates which are marked as off limit | API Endpoints -->

# Get List of candidates which are marked as off limit

**GET** `/v1/candidates/off-limit`
...
```
curl --request GET \
  --url https://api.recruitcrm.io/v1/candidates/off-limit \
