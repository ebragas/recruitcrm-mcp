<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/2be0f66a1b6b7-edit-a-candidate -->
<!-- title: Edit a candidate | API Endpoints -->

# Edit a candidate

**POST** `/v1/candidates/{candidate}`
...
- `candidate` (string, **required**) — slug of the candidate to edit
