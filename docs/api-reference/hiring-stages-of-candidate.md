<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/d6b83e692c6ed-hiring-stages-of-candidate -->
<!-- title: Hiring Stages of Candidate | API Endpoints -->

# Hiring Stages of Candidate

**GET** `/v1/candidates/{candidate}/hiring-stages`
...
```
curl --request GET \
  --url https://api.recruitcrm.io/v1/candidates/{candidate}/hiring-stages \
