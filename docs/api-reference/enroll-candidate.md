<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/cbba7f7c0d312-enroll-candidate -->
<!-- title: Enroll Candidate | API Endpoints -->

# Enroll Candidate

**POST** `/v1/candidates/{candidate}/enroll`
...
- `sequence_id` (integer, **required**) — ID of the sequence
...
```
curl --request POST \
  --url https://api.recruitcrm.io/v1/candidates/{candidate}/enroll \
