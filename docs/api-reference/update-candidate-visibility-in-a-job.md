<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/645592394b7b1-update-candidate-visibility-in-a-job -->
<!-- title: Update Candidate Visibility in a Job | API Endpoints -->

# Update Candidate Visibility in a Job

**POST** `/v1/candidates/{candidate}/visibility/{job}`
...
- `visibility` (integer, **required**) — Visibility of candidate in a Job: For On - 1, Off - 0
...
```
curl --request POST \
  --url https://api.recruitcrm.io/v1/candidates/{candidate}/visibility/{job} \
