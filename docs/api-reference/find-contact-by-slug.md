<!-- source: https://docs.recruitcrm.io/docs/rcrm-api-reference/55494075adaf1-find-contact-by-slug -->
<!-- title: Find contact by slug | API Endpoints -->
...
- `contact` (string, **required**) — slug of the contact to return
